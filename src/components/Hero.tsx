    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div ref={floatRef} className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center transition-transform duration-75 pt-20 md:pt-0">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-green-500/20 mb-8">
          ...
          <span className="text-sm text-neutral-400 font-mono-code">Looking for summer 2026 internships</span>
        </div>
        ...
        <p className="max-w-2xl text-neutral-400 text-base md:text-lg leading-relaxed mb-10">
          My journey began as a freelance web developer for nonprofits, and over time,
          my interests evolved toward AI and machine learning. I love training AI models and building applications that make daily life easier.
        </p>
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-12">
          ...
          <a
            href="/best_resume_shashanks.pdf"
            target="_blank"
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://linkedin.com/in/shagas" target="_blank" rel="noopener noreferrer"
            className="p-3 rounded-xl glass border border-white/10 hover:border-orange-500/30 hover:text-orange-400 text-neutral-400 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/10"
            aria-label="LinkedIn"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="mailto:shashankshaga.reddy@gmail.com"
            className="p-3 rounded-xl glass border border-white/10 hover:border-orange-500/30 hover:text-orange-400 text-neutral-400 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/10"
            aria-label="Email"
          >
