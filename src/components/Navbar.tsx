...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed z-50 transition-all duration-500 ${
      ...
      <div className={`flex items-center justify-between gap-6 px-5 py-3 rounded-2xl transition-all duration-500 ${
        scrolled
      ...
      {/* Mobile menu */}
      <div className={`md:hidden mt-2 glass border border-white/10 rounded-2xl overflow-hidden transition-all duration-300 ${
